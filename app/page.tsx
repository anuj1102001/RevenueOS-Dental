...
import RevenueWalkthrough from '@/components/RevenueWalkthrough';
import './clinic.css';
  ...
  return <div className="clinic-site">
    ...
    <main id="main-content">
      <section className="clinic-shell editorial-hero">
        <div className="hero-copy"><p className="kicker">PRECISION REIMAGINED / DUBAI</p><h1>Big questions.<br />Little worries.<br /><em>Let’s talk smiles.</em></h1><p className="hero-description">A friendlier first step into dental care. Explore what’s possible, ask what’s on your mind, and find your next step—at your own pace.</p><div className="hero-actions"><a className="c-button" href="#consult">Explore a consultation <span aria-hidden="true">↗</span></a><a className="c-text-link" href="#concierge">Meet your Smile Concierge <span aria-hidden="true">→</span></a></div><div className="hero-footnote"><span className="small-star" aria-hidden="true">✳</span><span>A little curiosity.<br />A more connected experience.</span></div></div>
        <div className="welcome-collage">
          <div className="collage-title"><span>HELLO, NEW POSSIBILITIES</span><span aria-hidden="true">✳</span></div>
          <div className="collage-smile" aria-hidden="true"><span className="eye eye-left"/><span className="eye eye-right"/><span className="friendly-smile"/></div>
          <div className="hello-sticker">A little less<br /><strong>“what if?”</strong><br />A little more<br /><strong>“let’s see.”</strong></div>
          <div className="collage-chat"><span className="chat-spark" aria-hidden="true">✦</span><div><span className="kicker">SMILE CONCIERGE</span><p>What’s on your mind?</p><a href="#concierge">Let’s start a conversation ↗</a></div></div>
          <a className="tour-sticker" href="#workflow"><span>FOR THE CLINIC TEAM</span><strong>Follow an enquiry<br />from hello to next step.</strong><span>TRY THE INTERACTIVE TOUR ↗</span></a>
        </div>
      </section>
      <div className="values-strip clinic-shell"><span>Real questions welcome</span><span>People first, always</span><span>A next step that makes sense</span></div>
      <section id="treatments" className="clinic-section clinic-shell">
        <div className="section-heading"><div><p className="kicker">01 / EXPLORE THE POSSIBILITIES</p><h2>What brings<br /><em>you here?</em></h2></div><p>Start with what matters to you. Every treatment journey begins with an assessment by a qualified dentist.</p></div>
    ...
    <footer className="clinic-footer clinic-shell"><div className="footer-top"><Link className="clinic-wordmark" href="/">PRECISION<span>REIMAGINED</span></Link><p>A warmer welcome.<br />A clearer next step.</p><Link className="c-text-link" href="/dashboard">RevenueOS owner access ↗</Link></div><div className="footer-bottom"><span>Independent proposal · Dubai</span><span>Built with RevenueOS</span><span>Not an official clinic website</span></div></footer>
  </div>;
}
